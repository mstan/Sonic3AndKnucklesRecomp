...
REPO_NAME="Sonic3AndKnucklesRecomp"      # GitHub repo / zip basename
APP_NAME="Sonic 3 and Knuckles"        # .app display name (may contain spaces)
TARGET="Sonic3KRecomp"            # cmake target == built binary filename in build-mac/
SYSTEM="genesis"            # nes | snes | genesis | vb | psx
VERSION="v0.2.0-macos"          # release tag, e.g. v0.1.0-macos
ROM_HINT="Sonic 3 __ROM_HINT__ Knuckles (Genesis) .bin/.md dump"        # human description of the ROM the user must supply
# ==============================================
