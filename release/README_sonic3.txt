Sonic3Recomp — native static recompilation of Sonic the Hedgehog 3
==================================================================
...
Sonic the Hedgehog 3 (USA) ROM next to the exe, named:

    sonic3.bin

then run Sonic3Recomp.exe. SRAM saves persist next to the exe (sonic3.srm).
...
Sonic the Hedgehog 3 is a trademark of SEGA. This project is not affiliated
